...
Gem::Specification.new do |spec|
  ...
  spec.authors = ["Mark Zelesky", "Kevin Reiss", "Ryan Laddusaw", "Regine Heberlein", "Max Kadel", "Christina Chortaria", "Jane Sandberg"]
  ...
  spec.extensions = ["ext/marc_match_key/Cargo.toml"]
